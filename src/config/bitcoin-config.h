...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Hppcoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Hppcoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/hppcoin/hppcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Hppcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Hppcoin Core 0.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "hppcoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "http://hppcoin.org/"
