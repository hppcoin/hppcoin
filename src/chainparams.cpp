...
//    std::cout << "CBigNum(4):" << cbn.GetHex();
    //  0x1e0ffff0 ==> 504365040 Decima.l  number of bits 
...
//        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000003418b3ccbe5e93bcb39b43");
        ...
        extraNonce[2] = 0x00;
        extraNonce[3] = 0x00;
        //change on 22 Nov to 1511365800 and also change Nonce
      //  genesis = CreateGenesisBlock(1510834951, 190007950, 0x1e0ffff0, 2, 0 * COIN, extraNonce);
      ...
      //  std::cout << "hppcoin  hashMerkleRoot hash: " << genesis.hashMerkleRoot.ToString() << std::endl;
        ...
        //btzc: update hppcoin cdnsseeddata`
