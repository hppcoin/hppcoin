...
/** btzc: update hppcoin config */
/** Default for DEFAULT_WHITELISTRELAY. */
static const bool DEFAULT_WHITELISTRELAY = true;
/** Default for DEFAULT_WHITELISTFORCERELAY. */
static const bool DEFAULT_WHITELISTFORCERELAY = true;
/** Default for -minrelaytxfee, minimum relay fee for transactions */
//btzc: update hppcoin fee
static const unsigned int DEFAULT_MIN_RELAY_TX_FEE = CENT / 10; //0.001 hppcoin,
...
/** The maximum size of a blk?????.dat, btzc:hppcoin: 128 MiB */
static const unsigned int MAX_BLOCKFILE_SIZE = 0x8000000; // 128 MiB;
/** The pre-allocation chunk size for blk?????.dat files (since 0.8), btzc:hppcoin: 16MiB */
static const unsigned int BLOCKFILE_CHUNK_SIZE = 0x1000000; // 16 MiB
/** The pre-allocation chunk size for rev?????.dat files (since 0.8), btzc:hppcoin: 1MiB */
static const unsigned int UNDOFILE_CHUNK_SIZE = 0x100000; // 1 MiB
/** Default for -blockprioritysize, maximum space for zero/low-fee transactions **/
static const unsigned int DEFAULT_BLOCK_PRIORITY_SIZE = 50000; // 50KB
/** Dust Soft Limit, allowed with additional fee per output */
//static const int64_t DUST_SOFT_LIMIT = 100000; // 0.001 HPP
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64_t DUST_HARD_LIMIT = 1000;   // 0.00001 HPP mininput
...
//CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams, int nTime = 1510834951);
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams, int nTime = 1511365800);
...
//BTZC: ADD params for hppcoin works
