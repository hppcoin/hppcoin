...
const char * const BITCOIN_CONF_FILENAME = "hppcoin.conf";
const char * const BITCOIN_PID_FILENAME = "hppcoind.pid";
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\hppcoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\hppcoin
    // Mac: ~/Library/Application Support/hppcoin
    // Unix: ~/.hppcoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "hppcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/hppcoin";
#else
    // Unix
    return pathRet / ".hppcoin";
#endif
#endif
}
...
boost::filesystem::path GetLMNodeConfigFile()
{
    boost::filesystem::path pathConfigFile(GetArg("-znconf", "lmnode.conf"));
