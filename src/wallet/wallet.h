...
enum AvailableCoinsType
{
    ...
    ONLY_1000 = 5, // find lmnode outputs including locked ones (use with caution)
...
public:
    ...
    // lmnode
    /// Get 1000 HPP output and keys which can be used for the LMNode
    bool GetLMNodeVinAndKeys(CTxIn& txinRet, CPubKey& pubKeyRet, CKey& keyRet, std::string strTxHash = "", std::string strOutputIndex = "");
