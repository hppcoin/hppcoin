...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        SendCoinsDialog->resize(850, 577);
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 HPP"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 HPP"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 HPP"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 HPP"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 824, 198));
        ...
        verticalLayoutFee2->setSizeConstraint(QLayout::SetMinimumSize);
        ...
        gridLayoutFee->setSizeConstraint(QLayout::SetNoConstraint);
        ...
        checkBoxMinimumFee->setEnabled(true);
        ...
        gridLayoutFee->addLayout(verticalLayoutFee8, 0, 0, 1, 1);
...
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks. But be aware that this can end up in a never confirming transaction once there is more demand for hppcoin transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks. But be aware that this can end up in a never confirming transaction once there is more demand for hppcoin transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
