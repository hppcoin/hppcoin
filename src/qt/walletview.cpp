    ...
    platformStyle(platformStyle)
{
    ...
    lmnodeListPage = new LMNodeList(platformStyle);
    addWidget(lmnodeListPage);
...
void WalletView::setClientModel(ClientModel *clientModel)
{
    ...
    lmnodeListPage->setClientModel(clientModel);
}
...
void WalletView::setWalletModel(WalletModel *walletModel)
{
    ...
    lmnodeListPage->setWalletModel(walletModel);
...
void WalletView::gotoLMNodePage()
{
    setCurrentWidget(lmnodeListPage);
}
