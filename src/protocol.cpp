...
//lmnode
    ...
    const char *LMNODEPAYMENTVOTE = "mnw";
    const char *LMNODEPAYMENTBLOCK = "mnwb";
    const char *LMNODEPAYMENTSYNC = "mnget";
...
const static std::string allNetMessageTypes[] = {
        ...
        NetMsgType::LMNODEPAYMENTVOTE,
        NetMsgType::LMNODEPAYMENTBLOCK,
        NetMsgType::LMNODEPAYMENTSYNC,
        NetMsgType::SPORK,
...
const char* CInv::GetCommand() const
{
    ...
    switch (type)
    {
        ...
        case MSG_LMNODE_PAYMENT_VOTE:    return NetMsgType::LMNODEPAYMENTVOTE;
        case MSG_LMNODE_PAYMENT_BLOCK:   return NetMsgType::LMNODEPAYMENTBLOCK;
        case MSG_LMNODE_ANNOUNCE:        return NetMsgType::MNANNOUNCE;
        case MSG_LMNODE_PING:            return NetMsgType::MNPING;
        case MSG_DSTX:                  return NetMsgType::DSTX;
        case MSG_LMNODE_VERIFY:          return NetMsgType::MNVERIFY;
        default: {
            return "error";
        }
    }
