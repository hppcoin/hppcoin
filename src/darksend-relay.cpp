...
CDarkSendRelay::CDarkSendRelay(CTxIn& vinLMNodeIn, vector<unsigned char>& vchSigIn, int nBlockHeightIn, int nRelayTypeIn, CTxIn& in2, CTxOut& out2)
{
    vinLMNode = vinLMNodeIn;
    vchSig = vchSigIn;
...
{
    CLMNode* pmn = mnodeman.GetLMNodeByRank(nRank, nBlockHeight, MIN_PRIVATESEND_PEER_PROTO_VERSION);
